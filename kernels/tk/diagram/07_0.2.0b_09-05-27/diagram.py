...
class Diagram:
	def __init__(self,master,diagram,shape=None):
		...
		self.panel=tk_diagram.Diagram(
				...
				event_handler_doublerightclick=self.open_save_dialog,
