...
class Diagram:
	def __init__(self,master,event_handler_start_zoom,event_handler_zoom,event_handler_start_pan,event_handler_pan,event_handler_doubleclick,event_handler_doublerightclick,image_computer,shape=None):
		if shape is None:
			shape=(200,200)
	...
	def tk_double_right_button(self,event):
		filename=tkFileDialog.asksaveasfilename(title='Save as EPS file')
		if filename:
			self.event_handler_doublerightclick(filename)
